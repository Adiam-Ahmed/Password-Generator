...
function getPasswordOptions() {
  passwordLength= parseInt(prompt("Please insert the password length,  Ensure it is atleast 8 character but no more than 128"));
  while (passwordLength < 8 || passwordLength >128 ) {
    passwordLength= parseInt(prompt("Ensure it is atleast 8 character but no more than 128, please re-insert the password length"));
  }
  charset = "";
